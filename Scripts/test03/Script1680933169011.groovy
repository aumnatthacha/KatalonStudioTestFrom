...
WebUI.setText(findTestObject('Object Repository/Page_REGISTER/input_First Name_firstname'), 'Natthacha')

WebUI.setText(findTestObject('Object Repository/Page_REGISTER/input_Last Name_lastname'), 'Mumdaeng')
